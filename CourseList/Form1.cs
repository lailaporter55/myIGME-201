...
namespace CourseList
{
    public partial class CourseListForm : Form
    {
        public CourseListForm()
        {
            ...
            this.courseListView.ItemActivate += new KeyEventHandler(CourseListView__ItemActivate);
            ...
            this.courseListView.SelectedIndexChanged += new KeyEventHandler(CourseListView__SelectedIndexChanged);

            // 5. disable updateButton (using the Enabled property)
            this.updateButton.Enabled = false;

            // 6. disable courseCodeTextBox
            this.courseCodeLabel.Enabled = false;
        ...
        public void PaintListView(string firstCourseCode)
        {
            ...
            if(firstCourseCode != null)
            {
                ...
                int indexFirstCourseCode = Globals.courses.sortedList.IndexOf(firstCourseCode);
            ...
            foreach (KeyValuePair<string, Course> keyValuePair in Globals.course.sortedList)
            {
        ...
        private void CourseListView__ItemActivate(object sender, EventArgs e)
        {
            ...
            if (course != null)
            {
                ...
                this.courseCodeTextBox.Text = course.description;
        ...
        private void UpdateButton__Click(object sender, EventArgs e)
        {
            ...
            this.CourseListView.Enable = true; 
            ...
            PaintListView(origCourseCode, copyCourse);
        }
