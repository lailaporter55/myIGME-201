    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            linkedList.AddLast((sentence[0] as string).Trim());
            linkedList.AddLast((sentence[3] as string).Trim());
            linkedList.AddLast((sentence[4] as string).Trim());
            linkedList.AddLast((sentence[5] as string).Trim());
            linkedList.AddLast((sentence[6] as string).Trim());
            linkedList.AddLast((sentence[8] as string).Trim());


            // 3. add "quick" and "brown" before "fox"

            // 4. your code here
            LinkedListNode<string> fox = linkedList.Find("fox");
            if(fox == null)
            {
                //"fox" is not found
            }
            ...
            {
                linkedList.AddBefore(fox, "quick");
                linkedList.AddBefore(fox, "brown");
            }
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            s = {"Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", 
                    "like", "a", "room", "without", "a", "roof","Because", "I'm", "sad",
                    "clap", "along", "if", "you", "feel", "like", "sadness", "is", "the", "truth", "sad"};
            ...
            if ((string)linkedListNode.Value == "sad")
            {
                (string)linkedListNode.Value = "happy";
            }
            if ((string)linkedListNode.Value == "sadness")
            {
                (string)linkedListNode.Value = "happiness";
            }
