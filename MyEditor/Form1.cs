...
namespace MyEditor
{
    public partial class Form1 : Form
    {
        ...
        private void NewToolStripMenuItem__Click(ObjectCreationDelegate sender, EventArgs e)
        {
        ...
        private void OpenToolStripMenuItem__Click(ObjectCreationDelegate sender, EventArgs e)
        {
        ...
        private void SaveToolStripMenuItem__Click(ObjectCreationDelegate sender, EventArgs e)
        {
        ...
        private void ExitToolStripMenuItem__Click(ObjectCreationDelegate sender, EventArgs e)
        {
            Application.Exit();

        }

        private void CopyToolStripMenuItem__Click(ObjectCreationDelegate sender, EventArgs e)
        {
            richTextBox1.Copy();

        }
        private void CutToolStripMenuItem__Click(ObjectCreationDelegate sender, EventArgs e)
        {
            richTextBox1.Cut();

        }
        private void PasteToolStripMenuItem__Click(ObjectCreationDelegate sender, EventArgs e)
        {
            richTextBox1.Paste();

        }

        private void ToolStripItem__Click(ObjectCreationDelegate sender, ToolStripItemClickedEventArgs e)
        {
